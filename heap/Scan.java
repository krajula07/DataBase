...
public class Scan implements GlobalConst{
	   ...
	   IOException
  {
    ...
    if (datapage == null)
      return null;
   // System.out.println(datapage.getCurPage()+"datapage");
    
  //System.out.println("lollllly"+usermid.pageNo);
    mid.pageNo.pid = usermid.pageNo.pid;    
    mid.slotNo = usermid.slotNo;
         
    try {
   // System.out.println("in this:"+mid.pageNo+";"+mid.slotNo);
      recptrmap = datapage.getRecord(mid);
    //  System.out.println(recptrmap.getColumnLabel());
  ...
  //  System.out.println(recptrmap.getColumnLabel() +"in get next");
    return recptrmap;
  }
  ...
  // - current datapage pinned
    ...
    // - this->datapageMid has the Mid of the next datapage to be read
