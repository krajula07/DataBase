  ...
  */
  ...
  public Map getRecord ( MID mid ) 
    ...
    //  System.out.println(mid.pageNo+","+mid.slotNo);
     ...
     // System.out.println(recLen+"record length in getRecord");
      slotCnt = Convert.getShortValue (SLOT_CNT, data);
      //System.out.println(slotCnt+"slotcount");
      if (( slotNo >=0) && (slotNo < slotCnt) && (recLen >0) 
	...
	//  System.out.println("lol");
	 ...
	 // System.out.println(map.getLength());
	  return map;
    	  ...
    	  System.out.println("in exception"+slotNo+";"+slotCnt+","+recLen+";"+pageNo.pid +":"+curPage.pid);
        throw new InvalidSlotNumberException (null, "HEAPFILE: INVALID_SLOTNO");
      }
   ...
   * @see 	Map
   */  
  public Map returnRecord ( MID mid )
    throws IOException, 
	   InvalidSlotNumberException
    {
      short recLen;
