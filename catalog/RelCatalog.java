  ...
  implements  GlobalConst, Catalogglobal
{
  ...
  public void getInfo(String relation, RelDesc record)
	...
	try {
	  ...
	  System.err.println ("read_map"+e4);
	  throw new RelCatalogException(e4, "read_map failed");
	}
  ...
  public void addInfo(RelDesc record)
	...
	System.err.println ("make_map"+e4);
	throw new RelCatalogException(e4, "make_map failed");
      }
  ...
  public void make_map(Map map, RelDesc record)
    throws IOException, 
	   RelCatalogException
    {
      try {
	...
	map.setIntFld(4, record.numMaps);
  ...
  public void read_map(Map map, RelDesc record)
    throws IOException, 
	   RelCatalogException
    {
      try {
	...
	record.numMaps = map.getIntFld(4);
  ...
  // void dumpRelation(fstream outFile, RelDesc relRec, int mapSize){}; 
