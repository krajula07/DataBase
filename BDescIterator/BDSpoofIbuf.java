...
public class BDSpoofIbuf implements GlobalConst  {
  
  /**
   *constructor, use the init to initialize
   */
  public void BDSpoofIbuf()
    {
   ...
   */
  public  void init(Heapfile fd, byte bufs[][], int n_pages,  int tSize,int Nmaps)
    throws IOException,
	   Exception
    {
      _fd       = fd;       _bufs        = bufs;
