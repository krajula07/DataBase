 ...
 */  
public abstract class BDpnodePQ
{
   ...
   */
  abstract public void  enq(BDpnode  item) 
   ...
   * @exception MapUtilsException error in map compare routines
   */
  public int pnodeCMP(BDpnode a, BDpnode b) 
         throws IOException, UnknowAttrType, BDUtilsException {
	 // System.out.println(fld_type+":::in PnodeCMP fldno:::"+fld_no);
    int ans = BDUtils.CompareMapWithMap(sort_order, a.map, b.map);
    return ans;
  }
   ...
   * @exception MapUtilsException error in map compare routines
   */  
  public boolean pnodeEQ(BDpnode a, BDpnode b) throws IOException, UnknowAttrType, BDUtilsException {
