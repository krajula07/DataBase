 ...
 */
public class BDOBuf implements GlobalConst{
  ...
  */
  ...
  public void init(byte[][] bufs, int n_pages, Heapfile temp_fd, boolean buffer)
  {
	  _bufs    = bufs;
	  _n_pages = n_pages;
	  t_size   = 79;
  ...
  public Map  Put(Map buf)
	   ...
	   Exception
    {
      ...
      //System.out.println(t_wr_to_pg * t_size+":"+t_size);
