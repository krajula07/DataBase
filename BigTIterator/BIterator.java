 ...
 */
public abstract class BIterator implements Flags {
  ...
  throws BIteratorBMException 
  {
	  try 
	  {
		  ...
		  throw new BIteratorBMException(e,"Iterator.java: freePage() failed");
	  }
  ...
  throws BIteratorBMException 
  {
	  ...
	  {
		  throw new BIteratorBMException(e,"Iterator.java: newPage() failed");
	  }
