 ...
 */  
public abstract class BpnodePQ
{
   ...
   */
  abstract public void  enq(Bpnode  item) 
   ...
   * @exception MapUtilsException error in map compare routines
   */
  public int pnodeCMP(Bpnode a, Bpnode b) 
         throws IOException, UnknowAttrType, BUtilsException {
	 // System.out.println(fld_type+":::in PnodeCMP fldno:::"+fld_no);
    int ans = BUtils.CompareMapWithMap(sort_order, a.map, b.map);
    return ans;
  }
   ...
   * @exception MapUtilsException error in map compare routines
   */  
  public boolean pnodeEQ(Bpnode a, Bpnode b) throws IOException, UnknowAttrType, BUtilsException {
