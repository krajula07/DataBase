 ...
 */
public class BpNodeSplayPQ extends BpnodePQ
{

  /** the root of the tree */
  protected BpnodeSplayNode   root;
  /*
 ...
 * @return 
   */  
  public  BpNodeSplayPQ(int fldNo, AttrType fldType, MapOrder order)
  {
    root = null;
    count = 0;
    fld_no   = fldNo;
  ...
  public  BpNodeSplayPQ(MapOrder order)
	{
		root = null;
		count = 0;
		sort_order = order;
   ...
   */
  public void enq(Bpnode item) throws IOException, UnknowAttrType, BUtilsException 
  {
    count ++;
    BpnodeSplayNode newnode = new BpnodeSplayNode(item);
    BpnodeSplayNode t = root;
    ...
    BpnodeSplayNode l = BpnodeSplayNode.dummy;
    BpnodeSplayNode r = BpnodeSplayNode.dummy;
     
    boolean done = false;

    while (!done) {
      if(comp>=0){
	BpnodeSplayNode tr = t.rt;
	if (tr == null) {
	  tr = newnode;
	  comp = 0;
	  done = true;
    ...
    if ((t.lt = BpnodeSplayNode.dummy.rt) != null) t.lt.par = t;
    if ((t.rt = BpnodeSplayNode.dummy.lt) != null) t.rt.par = t;
    t.par = null;
    root = t;
  ...
  public Bpnode deq() 
  {
    ...
    if (l == null) {
      ...
      while (true) {
	BpnodeSplayNode ll = l.lt;
	if (ll == null) {
	  if ((t.lt = l.rt) != null) t.lt.par = t;
	  return l.item;
	}
	else {
	  BpnodeSplayNode lll = ll.lt;
	  if (lll == null) {
